...
As a team you should spend \~30 minutes on this.

- Make sure you choose the dataset you want to work with from your proposal.
- Write up a plan for what you're doing with it.
- Include any work you've done so far on it.
