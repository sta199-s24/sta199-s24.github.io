...
Create a scatterplot of the percentage of people with a college degree (`percollege`) versus percentage below poverty (`percbelowpoverty`) where the color and shape of points are determined by `state`.
...
Now, let's examine the relationship between the same two variables, using a separate plot for each state, i.e., with faceting with `facet_wrap()`.
...
How can you tell this based on the plot?
...
Then, make a scatter plot of population density (`density`) vs. land area in miles-squared (`land_area_mi2`).
Describe the relationship.
Was your guess correct?
If not, can you think about any factors you might not have considered that cause this relationship?

### Question 9

Now make a scatter plot of population density (`density`) vs. land area in meters-squared (`land_area_m2`).
