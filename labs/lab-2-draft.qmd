...
A classmate says "Look at that, there is a county called ___ in each state in this dataset!"
In a single pipeline, discover all counties that could fill in the blank.
