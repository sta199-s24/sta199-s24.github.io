...
In a single pipeline, discover the most popular county names by counting how many times each name occurs in the dataset and displaying the results in order of descending counts.
Then, in a separate pipeline, discover which states these counties with most popular names are in.
