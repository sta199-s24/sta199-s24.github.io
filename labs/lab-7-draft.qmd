...
::: callout-important
If your code is running off the page so we can’t see your entire code, we will not evaluate any of it.
...
Explore attributes of bookings and summarize your findings in 5 bullet points.
...
a.  Create a subset of the data that only contains `Yes` and `No` answers for the harassment question.
    How many responsdents chose each of these answers?
