...
Now, what if calculated $R^2$ to help answer our question?
To compare the explanatory power of each individual predictor, we will look at �2 between the models.
...
a.  **Data:** For our analysis, we will only be working with data from 2007.
    ...
    ::: callout-note
    NOTE to Betsy: Alternatively we can just subset the data to cut down on the work a bit.
    :::
