...
-   **Question:** Take a look at the visualization.
    How are the continents ordered?
    What would be a better order?

Ordering the continents by the value of total population would be better.

-   **Demo:** Reorder the continents on the y-axis (levels of `continent`) in order of value of total population.
