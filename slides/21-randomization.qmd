...
- `calculate()` documentation: https://infer.tidymodels.org/reference/calculate.html

- **infer** pipelines: https://infer.tidymodels.org/articles/observed_stat_examples.html
